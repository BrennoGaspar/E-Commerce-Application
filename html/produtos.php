...
<head>
  ...
  <link rel="stylesheet" href="../css/styleprodutos1.css">
   ...
   while ($linha = $resultado->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '<fieldset>';
          ...
          echo '<div class="imagemform">';
            echo "<a href='visualizar.php?codigo=" . $linha["codigo"] . "'><img id='fotoproduto' src='data:image/jpeg;base64,".base64_encode( $linha['conteudo'] )."'/></a>";
          echo '</div>';
            echo '<br>';
              echo '<label class="labelInput" id="nomeproduto">' . $linha["nome"] . '</label>';
            echo '<br><br>';
               echo '<label class="labelInput" id="precoproduto">R$' . $linha["preco"] . '</label>';
            echo '<br><br>';
              echo '<a id="bt" href="../carrinho/carrinhohtml.php?acao=add&id='.$linha["codigo"].'">Comprar</a>';
    echo '</fieldset>';
    echo '</form>';
    echo '</div>';
    echo '<br>';
